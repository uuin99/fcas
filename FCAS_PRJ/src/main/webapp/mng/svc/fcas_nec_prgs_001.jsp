...
<head>
	...
	<script type="text/javascript">
		var trgt_tbl_nm = '<%=SystemCode.getCode("trgt_tbl_nm")%>';
		var nec_prgs_stat = '<%=SystemCode.getCode("nec_prgs_stat")%>';
	</script>
	...
	<script type="text/javascript" src="../fcas_nec_prgs_001.js"></script>
</head>
<body id="prog_body">
