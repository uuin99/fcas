...
<head>
	...
	<script type="text/javascript">
		var sms_rslt_type = '<%=SystemCode.getCode("sms_rslt_cd")%>';
		var sms_biz_type = '<%=SystemCode.getCode("sms_biz_type")%>';
	</script>
	...
	<script type="text/javascript" src="../fcas_sms_info_002.js"></script>
</head>
<body id="prog_body">
