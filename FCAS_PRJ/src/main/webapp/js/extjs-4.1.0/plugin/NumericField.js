...
Ext.define('Ext.ux.form.NumericField', 
{
	...
	initComponent: function(){
        ...
        if (this.readOnly) {
        	this.fieldStyle = 'background:rgb(235,235,235);text-align:right;';
        }
    },
    ...
    onKeyDown: function(e){
    	...
    	if((keyCode >= 65 && keyCode <= 90) || (keyCode == 229)){ //영/한 Key 입력 불가.
    		e.stopEvent();
    	}
	...
	setReadOnly: function(readOnly) {
	    ...
	    if (!readOnly) {
        	me.setFieldStyle('background:rgb(255,255,255);text-align:right;');
        } else {
        	me.setFieldStyle('background:rgb(235,235,235);text-align:right;');
        }
