...
<title>레포트 출력</title>
	...
	function fnOpen(){
		...
		oReport.rptname = "http://" + location.host + "/report/cus/fad/fcas_time_stat_rx_print.reb";
		
		oReport.con("XML1").type = "http";
		oReport.con("XML1").datatype = "xml";
		oReport.con("XML1").path = "http://" + location.host + "/cus/fad/SalesInfo/selectTimeStatPrintXml.do?rxParam="+parent.rxParam;
...
<body onload="fnOpen();" style="width:100%; height:100%; padding:0px; margin:0px;">
	<iframe name="ifrmRexPreview1" id="ifrmRexPreview1" src='/RexServer30/rexpreview.jsp'  style="width:816px; height:650px; padding:0px; border:1px; border-style:solid; border-color:#99BCE8;"></iframe>
	<script type="text/javascript">
