...
<title>레포트 출력</title>
	...
	function fnOpen(){
		...
		oReport.rptname = "http://" + location.host + "/report/cus/fad/fcas_dov_stat_rx_print.reb";
		
		oReport.con("XML1").type = "http";
		oReport.con("XML1").datatype = "xml";
		oReport.con("XML1").path = "http://" + location.host + "/cus/fad/SalesInfo/selectDovStatPrintXml.do?rxParam="+parent.rxParam;
