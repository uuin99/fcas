...
<head>
	...
	<script type="text/javascript" src="../fcas_chart_cond_001.js"></script>
</head>
<body id="prog_body" style="overflow:hidden;">
	...
	<div id="chart1_div" style="width:409px; height:500px; padding:10px 5px 0px 0px; float:left; position:relative;"></div>
	<div id="chart2_div" style="width:409px; height:500px; padding:10px 0px 0px 5px; float:left; position:relative;"></div>
</body>
</html>