...
//		idVersion.innerHTML = aParam[1];
		...
		//location.href="../rexpert30viewer.exe?" + sParam;
    	...
    	<div class="pullout-left left-125">
			...
			<div class="pullout-right right-wrap">
				...
				<div class="columns-2-Abb-A">
					<p><a class="download-button" id="buttonDownload" name="buttonDownload" href="../getviewer.jsp?f=rexpert30viewer.exe">Install</a></p>
					<p>
