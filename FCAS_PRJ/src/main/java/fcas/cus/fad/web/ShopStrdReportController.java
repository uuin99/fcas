 ...
 */
@Controller
public class ShopStrdReportController {
	 ...
	 * @exception
	 */
    @RequestMapping(value="/cus/fad/ShopStrdReport/selectShopStrdReportView.do")
...
//sw.start();
	    	...
	    	Map dbYmd = commonService.getDbYmdCustom("2014-02-24");
	    	...
	    	////String chk2 = (String)commonDAO.selectData("shopstrdreport.checkWorkYn", paramMap); // shopStrdReportService.checkWorkYn( paramMap ); //
	    	//String chk2 = (String)commonDAO.getSqlMapClient().queryForObject("shopstrdreport.checkWorkYn", paramMap); // shopStrdReportService.checkWorkYn( paramMap ); //
            //
	    	//if( chk2 != null) {
	    	//	// 기준일자 param1은 휴일이므로\n집계정보가 없습니다.
	    	...
	    	//0 입장객수 현황
	    	//0-1 전일 대비 현황
	    	List chart_0_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_0_1", paramMap); //shopStrdReportService.selectChart_0_1(paramMap);
	    	...
	    	//0-2 시간대별 추이
	    	List chart_0_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_0_2", paramMap); //shopStrdReportService.selectChart_0_2(paramMap);
...
//sw.start();
	    	...
	    	// 1-1 성별현황 차트 쿼리
	    	List chart_1_1_new = (List)commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_1_1_new", paramMap); //shopStrdReportService.selectChart_1_1(paramMap);

	    	Map<String, Object> chart_1_1 = (Map)commonDAO.getSqlMapClient().queryForObject("shopstrdreport.selectChart_1_1", paramMap); //shopStrdReportService.selectChart_1_1(paramMap);
	    	...
	    	// 1-2 연령대별 현황 쿼리
	    	List chart_1_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_1_2", paramMap); //shopStrdReportService.selectChart_1_2(paramMap);


	    	// 1-2 테이블 데이터
	    	Map tableData_1_2 = (Map)commonDAO.getSqlMapClient().queryForObject("shopstrdreport.selectTableData_1_2", paramMap); //shopStrdReportService.selectTableData_1_2(paramMap);
...
//sw.start();
	    	...
	    	// 2-1 성별 / 시간대별 방문 추이
			//List chart_2_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_2_1", paramMap); //shopStrdReportService.selectChart_2_1(paramMap);

			//shopstrdreport.selectChart_2_1 쿼리가 느려서 변경함..

			List chart_2_1_time = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_2_1_TimeData", paramMap);

			//List 에서 꺼내면서 shopstrdreport.selectChart_2_1 쿼리의 결과 형태로 묶어준다.
...
//sw.start();
	    	...
	    	// 2-2 연령대별/시간대별 방문 추이
	    	//List chart_2_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_2_2", paramMap); //shopStrdReportService.selectChart_2_2(paramMap);


			//shopstrdreport.selectChart_2_2 쿼리가 느려서 변경함..

			List chart_2_2_time = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_2_2_TimeData", paramMap);
...
//sw.start();
	    	...
	    	List chart_3_1_1 =  commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_1", paramMap); // shopStrdReportService.selectChart_3_1_1(paramMap);

	    	// 3-1 기준일 대비 전일비교 ( 연령대기준 )
	    	paramMap.put("targetDay", paramMap.get("preDay") ); // 전일 기준일
	    	paramMap.put("targetDay2", "D_"+paramMap.get("preDay") ); // 전일 기준일 ( - 붙인거 )
	    	List chart_3_1_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_2", paramMap); // shopStrdReportService.selectChart_3_1_2(paramMap);
			...
			*/
	    	...
	    	int pre_cnt = 0;
	    	try {
	    		pre_cnt = (Integer)commonDAO.getSqlMapClient().queryForObject("shopstrdreport.selectDaySumCnt", paramMap); //shopStrdReportService.selectDaySumCnt(paramMap);
	    	}catch (Exception e) {
	    		pre_cnt = 0;
	    	}
...
//sw.start();
	    	...
	    	List chart_3_2_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_1", paramMap); //shopStrdReportService.selectChart_3_1_1(paramMap);

	    	// 3-2 기준일 대비 전주 동요일 비교 ( 연령대기준 )
	    	List chart_3_2_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_2", paramMap); //shopStrdReportService.selectChart_3_1_2(paramMap);
	    	...
	    	//Object before_cnt_obj = commonDAO.getSqlMapClient().queryForObject("shopstrdreport.selectDaySumCnt", paramMap);
            //
	    	//int before_cnt = 0;
            //
	    	...
	    	int before_cnt = 0;
	    	try {
	    		before_cnt = (Integer)commonDAO.getSqlMapClient().queryForObject("shopstrdreport.selectDaySumCnt", paramMap); //shopStrdReportService.selectDaySumCnt(paramMap);
	    	}catch (Exception e) {
	    		before_cnt = 0;
	    	}
...
//sw.start();
	    	...
	    	// 4-1 설치 위치 별 방문자 현황
	    	List chart_4_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_4_1", paramMap); //shopStrdReportService.selectChart_4_1(paramMap);

	    	// 시사점 정보 String Make
	    	// 카메라 위치 별 방문자수는 서문 출입구가 가장 높았으며,<br />여성은 서문, 남성은 서문 출입구의 이용이 높았습니다.
	    	String sisa_4_1 = "설치 위치별 입장객수는 <span class='text_em'>pStr1</span>(이)가 가장 높았으며, 성별로는<br />여성은 <span class='text_em'>pStr2</span>, 남성은 <span class='text_em'>pStr3</span>의 이용이 높았습니다.";
...
//sw.start();
	    	...
	    	List chart_5_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_5_1", paramMap); //shopStrdReportService.selectChart_5_1(paramMap);
...
//System.out.println("::::::::->"+sw.getTime());
    	...
    	return "cus/fad/fcas_shop_strd_report_001";
    }
    ...
    @RequestMapping(value="/cus/fad/ShopStrdReport/selectShopStrdReportPrint.do")
    public String selectShopStrdReportPrint (HttpServletRequest request,
    		HttpServletResponse response,
    		ModelMap model) throws Exception {


    	return "cus/fad/fcas_shop_strd_rx_print_001";
    }



    @RequestMapping(value="/cus/fad/ShopStrdReport/selectShopStrdReportPrintXml2.do")
    ...
    @RequestMapping(value="/cus/fad/ShopStrdReport/selectShopStrdReportPrintXml.do")
    public ModelAndView selectRxTestView(HttpServletRequest request,
        ...
        try{
	    	...
	    	paramMap.put("targetDay", paramMap.get("preDay") ); // 전일 기준일
	    	paramMap.put("targetDay2", "D_"+paramMap.get("preDay") ); // 전일 기준일 ( - 붙인거 )
	    	List chart_3_1_1 =  commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_1_rex", paramMap); // shopStrdReportService.selectChart_3_1_1(paramMap);

	    	// 3-1 기준일 대비 전일비교 ( 연령대기준 )
	    	paramMap.put("targetDay", paramMap.get("preDay") ); // 전일 기준일
	    	paramMap.put("targetDay2", "D_"+paramMap.get("preDay") ); // 전일 기준일 ( - 붙인거 )
	    	List chart_3_1_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_2_rex", paramMap); // shopStrdReportService.selectChart_3_1_2(paramMap);
			...
			*/
	    	...
	    	// 3-2 기준일 대비 전주 동요일 비교 ( 성별기준 )
	    	List chart_3_2_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_1_rex", paramMap); //shopStrdReportService.selectChart_3_1_1(paramMap);

	    	// 3-2 기준일 대비 전주 동요일 비교 ( 연령대기준 )
	    	List chart_3_2_2 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_3_1_2_rex", paramMap); //shopStrdReportService.selectChart_3_1_2(paramMap);
	    	...
	    	List chart_4_1 = commonDAO.getSqlMapClient().queryForList("shopstrdreport.selectChart_4_1_rex", paramMap); //shopStrdReportService.selectChart_4_1(paramMap);
