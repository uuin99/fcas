 ...
 * @version       $Rev: 1.0 $
 */
@Service("shopStrdReportCpaService")
public class ShopStrdReportCpaServiceImpl extends AbstractServiceImpl implements ShopStrdReportCpaService {
    ...
    public List selectChart_0_1(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_0_1", model);
        return result;
    }
    /**
	 * 차트 정보를 조회한다.
    ...
    public List selectChart_0_2(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_0_2", model);
        return result;
    }
    /**
	 * 차트 정보를 조회한다.
    ...
    public Map selectChart_1_1(Map<String, Object> model) throws Exception {
    	Map result = (Map)commonDAO.selectData("shopstrdreportcpa.selectChart_1_1", model);
        return result;
    }
    /**
	 * 차트 정보를 조회한다.
    ...
    public List selectChart_1_2(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_1_2", model);
        return result;
    }
    /**
	 * 차트 정보를 조회한다.
    ...
    public Map selectTableData_1_2(Map<String, Object> model) throws Exception {
    	Map result = (Map)commonDAO.selectData("shopstrdreportcpa.selectTableData_1_2", model);
        return result;
    }
    /**
	 * 차트 정보를 조회한다.
    ...
    public List selectChart_2_1(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_2_1", model);
        return result;
    }
    /**
	 * 차트 정보를 조회한다.
    ...
    public List selectChart_2_2(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_2_2", model);
        return result;
    }
    ...
    public List selectChart_3_1_1(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_3_1_1", model);
        return result;
    }
    ...
    public List selectChart_3_1_2(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_3_1_2", model);
        return result;
    }
    ...
    public List selectChart_4_1(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_4_1", model);
        return result;
    }
    ...
    public List selectChart_5_1(Map<String, Object> model) throws Exception {
    	List result = commonDAO.selectList("shopstrdreportcpa.selectChart_5_1", model);
        return result;
    }
    ...
    public String checkWorkYn(Map<String, Object> model) throws Exception {
    	String result = (String)commonDAO.selectData("shopstrdreportcpa.checkWorkYn", model);
        return result;
    }
    ...
    public int selectDaySumCnt(Map<String, Object> model) throws Exception {
    	int cnt = (Integer)commonDAO.selectData("shopstrdreportcpa.selectDaySumCnt", model);
        return cnt;
    }
