...
/**
 * @logicalName   Day Chart Service Impl.
 * @description
 * @version       $Rev: 1.0 $
 */
@Service("daychartService")
public class DayChartServiceImpl extends AbstractServiceImpl implements DayChartService {

    @Resource(name="commonDAO")
    private CommonDAO commonDAO;

    /**
	 * Day Chart Query를 생성한다.
	 * @param model
    ...
    private StringBuilder getChartQuery(Map<String, Object> model){
		...
		String fromTable = "";
		if (sDiv.equals("1") || sDiv.equals("4") || sDiv.equals("5")) { //시간대별-입장객수, 시간대별-체류고객수, 시간대별-설치위치별 입장객수
	 ...
	 * @exception
	 */
    public ModelAndView selectDayChart(Map<String, Object> model) throws Exception {
	 ...
	 * @exception
	 */
    public ModelAndView selectDayChartNew(Map<String, Object> model) throws Exception {
...
//		sQuery.append("         AND WORK_YN   = 'Y') ");
	 ...
	 * @exception
	 */
    public ModelAndView selectDayChartCpa(Map<String, Object> model) throws Exception {
